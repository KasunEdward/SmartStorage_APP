...
public class RestAPI2 extends AsyncTask<Void,Void,Void>{
    HttpClient httpClient = new DefaultHttpClient();

    @Override
    protected Void doInBackground(Void... param) {
        int[] arr = {
                6,3,2074,4096,2073,2072,2073,2074,5467
        };
        ...
        try {
            HttpPost httpPostRequest = new HttpPost("http://192.168.43.65:5000/predict2");
